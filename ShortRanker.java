...
public class ShortRanker {
    
    //Given the input query, find the 100 highest ranked pages and write them to a file
    ...
    //Repeat doPagingSearch for every page indexed
    public static void main(String[] args) throws Exception {
	    
        String query_string=null;
        String path = System.getProperty("user.dir");
        String index = path + "\\IndexOfShortRepr"; //input dir
        String ShortReprLists = path + "\\ShortReprLists"; //output dir
        new File(ShortReprLists).mkdir();
        ...
        for(int i = 0; i < reader.numDocs();i++) {
            ...
            PrintWriter writer = new PrintWriter(ShortReprLists + "/" +titleID + ".txt", "UTF-8");
